...
Java_com_whispercpp_whisper_WhisperLib_00024Companion_fullTranscribe(
        JNIEnv *env, jobject thiz, jlong context_ptr, jint num_threads, jfloatArray audio_data, jstring language_str, jboolean detect_language) {
    UNUSED(thiz);
    struct whisper_context *context = (struct whisper_context *) context_ptr;
    ...
    params.detect_language = detect_language == JNI_TRUE;
    params.language = params.detect_language ? NULL : (language_chars != NULL ? language_chars : "zh");
